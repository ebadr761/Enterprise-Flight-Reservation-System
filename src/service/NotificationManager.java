...
public class NotificationManager {
    ...
    /**
     * Attach an model.observer to the notification system.
     * Prevents duplicate observers of the same type.
     */
    public void attach(NotificationObserver observer) {
        // Check if an model.observer of this type already exists
    ...
    /**
     * Detach an model.observer from the notification system.
     */
