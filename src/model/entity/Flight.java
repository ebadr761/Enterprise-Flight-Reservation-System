...
/**
 * Flight entity representing scheduled flights in the system.
 * Manages flight details, seat availability, and status tracking.
 * Supports seat reservation and release operations for booking management.
 */
public class Flight {
    ...
    /**
     * Checks if the flight has enough available seats for the requested number.
     *
     ...
     * Only reserves if enough seats are available.
     *
    ...
    /**
     * Releases seats back to the available pool when a booking is cancelled.
    ...
    /**
     * Returns formatted departure time for display purposes.
     *
     * @return Departure time in "yyyy-MM-dd HH:mm" format
     */
    ...
    /**
     * Returns formatted arrival time for display purposes.
     *
     * @return Arrival time in "yyyy-MM-dd HH:mm" format
     */
